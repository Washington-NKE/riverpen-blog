...
import { AdjacentPost } from '@/models/Post';
...
const AdjacentPostCard = ({ post, position }: AdjacentPostCardProps) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-gradient-to-r from-[#cd19ff] to-[#e000ac] left-4 rounded-full">
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-gradient-to-r from-[#cd19ff] to-[#e000ac] right-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
